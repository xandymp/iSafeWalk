...
<nav id="sidebar">
    ...
    <div class="col-sm-3 title">
        <h2>Employee Status&nbsp;<span style="font-size: 1.25rem;color: #cccccc">(243)</span></h2>
        <br/>
        <div class="buttons">
            <button type="button" class="btn btn-light btn-sm btn-active">All</button>
            <button type="button" class="btn btn-light btn-sm">Infected (1)</button>
            <button type="button" class="btn btn-light btn-sm">Exposed (4)</button>
        </div>
        <hr/>
        <div class="employees">
            <div class="col-sm-2">

        ...
        <nav id="sidebar">
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <a href="#pageSubmenu">
                        <svg class="bi bi-shuffle" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="employees">
                <div class="col-sm-2">
                    <svg class="bi bi-person" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <rect height="3em" width="3em" fill="#f1f1f1" />
                ...
                <div class="col-sm-4">
                    <svg class="bi bi-arrow-repeat" width="1em" height="1em" viewBox="0 s0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="float: left">
                    ...
                    &nbsp;
                    <span style="font-size: 8pt; float: left">2 min ago</span>
                </div>
                <div class="col-sm-1">

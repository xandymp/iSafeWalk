...
<body>
    <div class="wrapper">
        ...
        <div class="col-sm-3 title">
            <a id="create-device" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus" style="font-size: inherit"></i></a>
            ...
            @foreach($devices as $device)
                <div class="list" data-id="{{ $device->id }}">
                    ...
                    <div class="col-sm-1">
                        <a class="btn btn-danger btn-sm delete" data-id="{{ $device->id }}">
